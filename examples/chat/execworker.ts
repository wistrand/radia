...
const RUN_CODE: ToolDef = {
  ...
  function: {
    ...
    description:
      ...
      `fetch/Deno.readTextFile/Deno.env — they fail. It cannot see the conversation or the space ` +
      `either: pass any data you need INSIDE the code as literals. Modern JS is available (no ` +
