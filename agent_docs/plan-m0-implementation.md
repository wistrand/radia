...
> Status: Phases 0–7 DONE (187 conformance tests across the embedded adapters and the blob port, 213 including a
...
**All M0 phases (0–7) are DONE**, verified (187 conformance tests across the embedded adapters and the blob port;
