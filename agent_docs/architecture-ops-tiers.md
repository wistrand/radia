...
team entry in CLAUDE.md said "there is no tier between it and `createdBy: 'self'`"; both predate this
tier and are corrected. Before widening a grant to make a view work, check which HALF of the plane
the view uses.
