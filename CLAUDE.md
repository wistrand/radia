...
| `src/surfaces/cli.ts`                   | the CLI verbs (health/stats/doctor/erasures/kinds/put/query/take/ack/watch/workspaces/workspace-git/…), public `/v0` only |
