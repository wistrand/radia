...
| `src/surfaces/cli.ts`                   | the CLI verbs (health/stats/doctor/kinds/put/query/take/ack/watch/workspace-git/…), public `/v0` only |
